...
setup (
	...
	entry_points={'console_scripts': ['openplotter-pypilot=openplotterPypilot.openplotterPypilot:main','pypilotPostInstall=openplotterPypilot.pypilotPostInstall:main','pypilotPreUninstall=openplotterPypilot.pypilotPreUninstall:main','openplotter-pypilot-read=openplotterPypilot.openplotterPypilotRead:main','pypilot-check-security=openplotterPypilot.pypilotCheckSecurity:main']},
