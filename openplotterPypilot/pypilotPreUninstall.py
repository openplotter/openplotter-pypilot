...
def main():
	...
	try:
		...
		subprocess.call(['systemctl', 'disable', 'check-pypilot-security'])
		...
		subprocess.call(['systemctl', 'stop', 'check-pypilot-security'])
		...
		os.system('rm -f /etc/systemd/system/check-pypilot-security.service')
